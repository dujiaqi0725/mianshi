    ...
    <PageContainer>
      <ProTable<API.QuestionBank>
        ...
        request={async (params, sort, filter) => {
          ...
          const { data } = await listQuestionBankByPageUsingPost({
            ...params,
            sortField,
            sortOrder,
            ...filter,
          ...
          const pageQuestionBank = data as API.PageQuestionBank_
          const baseResponsePageQuestionBank = await listQuestionBankByPageUsingPost({}) as API.BaseResponsePageQuestionBank_

          return {
            success: baseResponsePageQuestionBank.code === 0,
            data: pageQuestionBank?.records || [],
            total: Number(pageQuestionBank?.total) || 0,
          };
        }}
        columns={columns}
      />
